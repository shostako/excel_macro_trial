Attribute VB_Name = "m日別集計_加工作業者別"
Option Explicit

' 加工作業者別日別集計マクロ（空白値を0に変換）
' 「全工程」テーブルから「加工1」「加工2」工程のデータを日付・作業者でグループ化して集計
Sub 日別集計_加工作業者別()
    ' 高速化設定（最優先）
    ...
    outputSheetName = "日別集計_加工作業者別"
    outputTableName = "日別集計_加工作業者別テーブル"
